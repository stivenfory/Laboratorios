...
<select name="vehiculo_id" id="vehiculo_id" class="form-control selectpicker" data-livesearch="true"
required>
...
<input type="text" name="fecha_ingreso" class="form-control" placeholder="valor Hora..." value="{{date('Y-m-d H:i:s') }}" disable readonly>
 </div>
 <div class="form-group">
